...
<script src="${pageContext.request.contextPath}/js/mine/student.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	$(function(){
		//创建富文本编辑器
		itemAddEditor = TAOTAO.createEditor("#editStudentForm [name=desc]");
		//初始化类目选择和图片上传器
	...
	function submitForm(){
		//有效性验证
		if(!$('#editStudentForm').form('validate')){
			$.messager.alert('提示','表单还未填写完成!');
			return ;
		}
		//$("#itemAddForm").serialize()将表单序列号为key-value形式的字符串
		$.post("/StudentManagers/studentAction!updateStudent.action",$("#editStudentForm").serialize(), function(data){
...
<body>
	...
	<table id="studentList" title="学生信息" class="easyui-datagrid"
		style="width:100%;height:600px"
		url="${pageContext.request.contextPath}/studentAction!showStudents.action"
		toolbar="#toolbar,#tb" rownumbers="true" fitColumns="true"
		singleSelect="true" pagination="true">
		<thead>
			<tr>
				<th field="userId" width="50">学号</th>
	...
	<div id="tb" style="padding:3px">
		...
		<span style="width: 20sp">通过学号搜索</span>
	...
	<div id="toolbar">
		...
		<shiro:hasPermission name="student:update">
			<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="openEditStudentDialog()">编辑学生</a>
		</shiro:hasPermission>
		
		<shiro:hasPermission name="student:delete">
			<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="openDeleteStudentDialog()">删除学生</a>
		</shiro:hasPermission>
		
		<a href="#"
			class="easyui-linkbutton" iconCls="icon-edit" plain="true" 
			onclick="openShowStudentDialog()">查看学生</a>
		
		<shiro:hasPermission name="user:addRole">
			<a href="#"
			class="easyui-linkbutton" iconCls="icon-edit" plain="true" 
			onclick="openAddRoleStudentDialog()">修改权限</a>
		</shiro:hasPermission>
	</div>


	
	<div id="editStudentDialog" class="easyui-dialog"
		style="width:800px;height:600px;padding:10px 20px" closed="true"
		buttons="#editStudentDialog-buttons">
		<div style="padding:10px 10px 10px 10px">
	<form id="editStudentForm" class="itemForm" method="post" enctype="multipart/form-data">
	    <table cellpadding="5">
	        <tr class="fitem">
	            <td>学号/工号:</td>
	        ...
	        <tr>
	            ...
	            <td>
	                 ...
	                 <input id="teacherImage"type="hidden" name="headUrl"/>
	            </td>
	        </tr>
	    </table>
	...
	<div id="showStudentDialog" class="easyui-dialog"
		style="width:800px;height:600px;padding:10px 20px" closed="true"
		buttons="#editStudentDialog-buttons">
		<div style="padding:10px 10px 10px 10px">
	<form id="showStudentForm" class="itemForm" method="post" enctype="multipart/form-data">
	    <table cellpadding="5">
	        <tr class="fitem">
	            <td>学号/工号:</td>
	            <td><input class="easyui-textbox" type="text" name="userId" data-options="required:true" style="width: 280px;"></input></td>
